import{b as S,c as D,r as a,j as t,a as z,f as C,l as T}from"./index-D2xurMBg.js";const q=""+new URL("signator-CHkqwlLk.svg",import.meta.url).href;function I(){const{hasRole:b,userInfo:i}=S(),{activeTerm:g}=D(),[x,u]=a.useState([]),[y,m]=a.useState(!1),[h,N]=a.useState(null),[c,j]=a.useState("asc");if(!b("teacher"))return t.jsx("div",{className:"card shadow-sm",children:t.jsx("div",{className:"card-body",children:t.jsxs("div",{className:"alert alert-danger text-center",children:[t.jsx("i",{className:"fa fa-ban ml-2"}),"شما مجاز به دسترسی به این بخش نیستید."]})})});const f=a.useCallback(async()=>{m(!0);try{const e=new URLSearchParams;i?.fullName?e.append("questionDesigner",i.username):i?.username&&e.append("questionDesigner",i.fullName),e.append("pageSize",1e3);let r=(await z.get(`/api/exams/paged?${e.toString()}`)).items||[];h&&(r=w(r,h,c)),u(r)}catch(e){console.error("خطا در دریافت دروس:",e),alert("❌ خطا در دریافت لیست دروس")}finally{m(!1)}},[i?.fullName,i?.username,h,c]),w=(e,n,r)=>[...e].sort((s,k)=>{let d=s[n]||"",l=k[n]||"";return n==="registered"&&(d=parseInt(d)||0,l=parseInt(l)||0),r==="asc"?d>l?1:d<l?-1:0:d<l?1:d>l?-1:0}),o=e=>{h===e?j(c==="asc"?"desc":"asc"):(N(e),j("asc"))},p=e=>h!==e?t.jsx("i",{className:"fa fa-sort text-muted ms-1",style:{fontSize:"12px"}}):c==="asc"?t.jsx("i",{className:"fa fa-sort-asc text-primary ms-1",style:{fontSize:"12px"}}):t.jsx("i",{className:"fa fa-sort-desc text-primary ms-1",style:{fontSize:"12px"}});function v(e){if(e==null)return"";const n=e.toString(),r=["۰","۱","۲","۳","۴","۵","۶","۷","۸","۹"];return n.replace(/\d/g,s=>r[parseInt(s)])}const $=()=>{const e=window.open("","_blank"),n=x.map(s=>`
            <tr>
                ...
                <tr>
                    ...
                    <td style="border: none; text-align: center; position: relative;">
                        ...
                        <div style="position: relative; display: inline-block;">
                            ...
                            <img src="${q}" alt="امضا" style="position: absolute; top: -15px; left: 0; width: 100px; height: auto; opacity: 0.8;" />
